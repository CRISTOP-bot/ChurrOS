...
file_permissions=(
  ...
  ["/usr/bin/churros-store"]="0:0:755"
  ["/etc/polkit-1/rules.d/50-churros-store.rules"]="0:0:644"
  ...
  ["/usr/share/icons/hicolor/scalable/apps/churros-store.svg"]="0:0:644"
  ...
  ["/usr/share/icons/hicolor/128x128/apps/churros-store.png"]="0:0:644"
