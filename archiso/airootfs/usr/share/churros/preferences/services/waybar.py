...
class WaybarService:
    ...
    def _write_style(cls, values):
        ...
        alpha_pct = int(bg_alpha * 100)

        css = f"""/* Auto-generated by churros-settings WaybarService — Liquid Glass */
...
#workspaces button:hover {{
    background-color: alpha(@color4, 0.10);
    color: @foreground;
}}
...
#mpris {{
    ...
    padding: 2px 10px;
    margin: 3px 3px;
    background-color: alpha(@background, {max(0.0, bg_alpha - 0.3):.2f});
    border: 1px solid alpha(@foreground, 0.06);
}}
...
#custom-dnd:hover {{
    background-color: alpha(@color4, 0.14);
}}
